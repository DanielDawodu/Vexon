...
export default function DealersPage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const res = await fetch('https://formspree.io/f/mzdjnwwn', {
                method: 'POST',
                headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    'Dealer Name': form.dealerName,
                    'Location': form.location,
                    'Available Cars': form.availableCars,
            ...
            if (res.ok) {
                setStatus('success');
                setMessage('Your application has been received. Our team will review and get back to you.');
    ...
    const benefits = [
        {
            ...
            description:
                'Clearline Auto brings buyers who have already been screened and matched based on their requirements.',
            icon: (
        ...
        },
        {
            ...
            description:
                'Your inventory stays with you. Clearline Auto simply connects you with the right buyers.',
            icon: (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        },
        {
            ...
            description:
                'Clearline Auto manages the process from introductions through to documentation and handover.',
            icon: (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className={styles.grid}>
                    ...
                    <div>
                        ...
                        <div className={styles.formCard}>
                            <h2>Become a Clearline Auto Partner</h2>
                            <form onSubmit={handleSubmit}>
                                ...
                                >
                                    {status === 'loading'
                                        ? 'Submitting...'
                                        : 'Become a Clearline Auto Partner'}
                                </button>
                            </form>
                        </div>
                    </div>
