...
export const metadata: Metadata = {
    title: 'About – Clearline Auto',
    description:
        'Learn about Clearline Auto, a professional car brokerage built on trust, transparency, and verified processes.',
};
            ...
            <div className={styles.inner}>
                ...
                <div className={styles.heroImage}>
                    <Image
                        ...
                        alt="Trust and transparency at Clearline Auto"
                        width={780}
                        height={420}
                ...
                <div className={styles.content}>
                    ...
                    <p>
                        ...
                        check, and every interaction through Clearline Auto is designed to lower risk
